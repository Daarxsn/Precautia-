...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText edUsername, edPassword, edEmail, edConfirm_password;
    Button btn;
    TextView  tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edConfirm_password = findViewById(R.id.editTextAppFees);
                ...
                if (username.length()==0 || Email.length()==0 || password.length()==0 || Confirm_password.length()==0){
                    ...
                    if (password.compareTo(Confirm_password)==0) {
                        if (isValid(password)) {
                            ...
                            Toast.makeText(getApplicationContext(), "password must contain 8 characters, having a digit, numerical and a special character ", Toast.LENGTH_SHORT).show();
                        }
                    }else{
